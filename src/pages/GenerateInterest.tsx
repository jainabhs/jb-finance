  ...
  return (
    <div className="space-y-4 sm:space-y-5 overflow-hidden">
      ...
      {loan && activeTab === "draft" && fullCalculation && fullCalculation.periods.length > 0 && (
        <div className="fixed bottom-[4.5rem] lg:bottom-0 left-0 right-0 z-40 lg:bg-white/95 lg:dark:bg-slate-900/95 lg:backdrop-blur-xl lg:border-t lg:border-slate-200 lg:dark:border-slate-700/60 lg:shadow-[0_-4px_20px_rgba(0,0,0,0.08)] lg:dark:shadow-[0_-4px_20px_rgba(0,0,0,0.3)] lg:safe-area-bottom px-5 lg:px-0">
